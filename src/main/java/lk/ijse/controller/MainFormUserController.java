...
public class MainFormUserController {
    ...
    @FXML
    void historyBtnOnAction(ActionEvent event) throws IOException, SQLException {
        setForms("/view/history_form.fxml");
    }

    @FXML
    void homeBtnOnAction(ActionEvent event) throws IOException, SQLException {
        setForms("/view/book_form.fxml");
    }

    @FXML
    void profileBtnOnAction(ActionEvent event) throws IOException, SQLException {
        setForms("/view/profile_form.fxml");
    }

    @FXML
    void settingsBtnOnAction(ActionEvent event) throws IOException, SQLException {
        setForms("/view/profile_form.fxml");
    }

    @FXML
    void shelfBtnOnAction(ActionEvent event) throws IOException, SQLException {
